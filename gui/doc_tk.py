...
# set the checked state (var=_chk_state) by passing the checkvalue
# to the checkbutton
...
# if you forget to call the mainloop function,
# nothing will appear to the user
window.mainloop()
